                    ...
                    <div class="card-header d-flex-align-items-center pb-0">
                        <ul class="list-inline mb-0">
                            <li class="list-inline-item float-left">
                                <h4><i class="c-icon cil-menu"></i> Daftar Slider</h4>
                            </li>
                            <li class="list-inline-item float-right">
                                <div class="d-none d-md-block">
                                    <a href="{{ route('sliders.create') }}" class="btn btn-sm btn-primary mb-3 mr-auto">
                                        <i class="c-icon cil-plus"></i>
                                        Slider
                                    </a>
                                </div>
                                <div class="d-md-none float-right">
                                    <a href="{{ route('sliders.create') }}" class="btn btn-sm btn-primary mb-3">
                                        <i class="c-icon cil-plus"></i>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                @include('dashboard.sliders._table')
